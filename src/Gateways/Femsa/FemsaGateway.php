 ...
 */
class FemsaGateway extends AbstractGateway
{
    /**
     ...
     * @var string
     */
    protected $endpoint = 'https://api.digitalfemsa.io';
    ...
    public function commit($method, $url, $params = [], $options = [])
    {
        ...
        $request = [
            ...
            'connect_timeout' => '30',
            'headers'         => [
                'Accept'                      => "application/vnd.app-v{$this->config['version']}+json",
                'Accept-Language'             => $this->config['locale'],
                'Authorization'               => 'Basic '.base64_encode($this->config['private_key'].':'),
                'Content-Type'                => 'application/json',
                'RaiseHtmlError'              => 'false',
                'X-Femsa-Client-User-Agent'   => json_encode($userAgent),
                'User-Agent'                  => 'Femsa/v2 PayMeBindings/'.$this->config['version'],
            ],
        ];
