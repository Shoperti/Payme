...
class PaypalPlusGateway extends AbstractGateway
{
    ...
    public function commit($method, $url, $params = [], $options = [])
    {
        ...
        $response = $this->respond($response, $params, $rawResponse->getStatusCode());
    ...
    /**
     * Configures the raw response before the mapping.
     *
     ...
     * @return array
     */
    protected function respond($response, $request, $statusCode)
    {
    ...
    public function mapResponse($response, $statusCode)
    {
        ...
        $state = $this->getSuccessAndStatus($response, $statusCode, $type);
     ...
     * @return array
     */
    private function getSuccessAndStatus($response, $code, $type)
    {
