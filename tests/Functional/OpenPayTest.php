...
class OpenPayTest extends AbstractFunctionalTestCase
{
    ...
    public function it_should_create_a_new_openpay_gateway()
    {
        ...
        $this->assertInstanceOf(OpenPayGateway::class, $openPayPayMe->getGateway());
        $this->assertInstanceOf(Charges::class, $openPayPayMe->charges());
    }
    ...
    public function is_should_succeed_to_charge_a_token_with_params()
    {
        ...
        $payload = [
            'reference'        => 'order_'.microtime().rand(10000, 99999),
            'device_id'        => 'test',
    ...
    {
        $response = (new GuzzleClient())->post("https://sandbox-api.openpay.mx/v1/{$credentials['id']}/tokens", [
            'headers' => [
